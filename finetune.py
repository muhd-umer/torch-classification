...
Finetuning script for Pytorch [Pytorch Lightning]

Usage:
    >>> python finetune.py --help
    >>> python finetune.py --data-dir <path> --model-dir <path> --batch-size <int> --num-workers <int> --num-epochs <int> --lr <float> --rich-progress --accelerator <str> --devices <str> --weights <path> --resume --test-only
...
Example:
    ...
    Override the config:
    >>> python finetune.py --data-dir data --model-dir models --batch-size 128 --num-workers 8 --num-epochs 100 --lr 0.001 --rich-progress --accelerator gpu --devices 1 --weights models/best_model.ckpt --resume --test-only
"""
